...
for ( let i = 0; i < pokemons.length; i++) {
    ...
    card.setAttribute("class", "bg-white w-[330px] h-[423px] rounded-[20px] border-[2px] border-[#000] border-solid flex flex-col justify-between pt-6 items-center");
    ...
    <img src="${pokemons[i].img}" alt="">
              <div class="main__cards--card-body pt-3 w-[100%] h-[40%] border-t-[2px] border-t-black border-t-solid flex justify-between flex-col">
                <div class="w-[100%] pl-8">
                  <h4 class="text-black text-2xl font-bold">${pokemons[i].name}</h4>
                  <small class="text-[20px] text-black font-semibold">${pokemons[i].type}</small>
                  
                </div>
                <div class="main__cards--card-body-info flex justify-around items-start w-[100%] h-[40%]">
                  <strong class="font-semibold text-[24px]">${pokemons[i].weight}</strong>
                  <strong class="font-semibold text-[24px]">${pokemons[i].avg_spawns} age</strong>
                </div>
              </div>
    `;
    main.append(card)
